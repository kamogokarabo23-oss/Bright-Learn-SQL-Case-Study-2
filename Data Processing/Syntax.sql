SELECT * FROM brightTV.CaseStudy.user_profiles;
SELECT * FROM BrightTV.Casestudy.viewership;
...
SELECT 
    ...
    MAX(LOCAL_TIMESTAMP),
    --AVG(duration_2)
FROM brightTV.Casestduy.viewership;
...
SELECT * FROM brightTV.Casestduy.user_profile
